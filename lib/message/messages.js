 ...
 */
function Message( type, opt ) {
    opt = opt || {};
    this.type = type;
    this.ack  = opt.ack ? Math.random() * Number.MAX_SAFE_INTEGER : false;
}
...
function ACK( uid ) {
    ...
    // Call super constructor
    Message.call( this, "ack" );

    // Set variables
    this.uid = uid;
}

ACK.prototype = Object.create( Message.prototype );
...
function MARCO( ) {
  ...
  // Call super constructor
  Message.call( this, "marco", { ack : true } );

}

MARCO.prototype = Object.create( Message.prototype );


// Export this message
module.exports.MARCO = MARCO;
